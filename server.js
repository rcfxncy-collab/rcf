...
app.post("/customer/check-bill", (req, res) => {

 const billNumber = req.body.billNumber;
 const mobile = req.body.mobile;

 const bill = bills.find(
  b => b.billNumber == billNumber && b.mobile == mobile
 );
...
app.get("/admin/get-bills",async (req, res) => {
    try {
